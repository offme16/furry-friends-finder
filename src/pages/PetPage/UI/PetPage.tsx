    ...
    <div className={cls.PetPage}>
      ...
      <div>
        ...
        <div className={cls.description}>
          ...
          Accusantium, mollitia asperiores ipsa quae tenetur odit itaque quod
          cupiditate dolores nesciunt explicabo enim in vitae est similique nisi
          animi inventore provident.
        </div>
      </div>
